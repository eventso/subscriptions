...
public sealed class PoisonEventStore(IConnectionFactory connectionFactory) : IPoisonEventStore
{
        ...
        CancellationToken token)
    {
        ...
        command.Parameters.Add(new NpgsqlParameter<string>("groupId", groupId));
        command.Parameters.Add(new NpgsqlParameter<ReadOnlyMemory<byte>>("key", @event.Key));
        command.Parameters.Add(new NpgsqlParameter<ReadOnlyMemory<byte>>("value", @event.Value));
        command.Parameters.Add(new NpgsqlParameter<DateTime>("creationTimestamp", @event.CreationTimestamp));
        ...
        command.Parameters.Add(new NpgsqlParameter<int>("totalFailureCount", @event.FailureCount));
